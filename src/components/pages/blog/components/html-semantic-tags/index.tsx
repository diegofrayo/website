...
export function HST_Main(): T_ReactElement {
	return (
		<main
			role="main"
			className="dfr-bg-color-wb-inv dark:tw-bg-gray-400"
			style={{ minWidth: 500 }}
		>
			<header className="dfr-bg-color-primary tw-p-2 tw-text-center dark:tw-bg-gray-600">
				<h1>header</h1>
				<nav>
					<ul>
			...
			<div className="tw-flex tw-p-3">
				...
				<section className="tw-w-3/5 tw-pl-2">
					...
					<article className="tw-border tw-p-2">
						...
						<footer className="tw-mt-4 tw-p-1 tw-text-center tw-text-sm dfr-text-color-white-pin dfr-bg-color-bw-inv">
							article footer
						</footer>
					</article>
					<hr className="tw-my-3 tw-border-0" />
			...
			<footer className="tw-mt-6 tw-p-2 tw-text-center dfr-text-color-white-pin dfr-bg-color-bw-inv">
				footer
			</footer>
		</main>
	);
