...
function GuitarChord(props: T_GuitarChordProps): T_ReactElement {
	...
	return (
		...
		>
			<Block
				is="section"
				className="tw-pb-2 dark:dfr-bg-color-primary-inv"
			...
			>
				...
				<Block className="tw-flex-no-wrap tw-inline-flex tw-max-w-full tw-items-end tw-overflow-x-auto">
					...
					<Block className="tw-flex-no-wrap tw-relative tw-inline-flex">
						...
						<Block className="tw-relative tw-top-6 tw--left-0.5 tw-h-36 tw-w-3 tw-rounded-tr-md tw-rounded-br-md dfr-bg-color-bw-inv dark:dfr-bg-color-wb-inv" />
					</Block>
			...
			<Block className="tw-text-sm">
				...
				{showChordInput && (
					<Block className="tw-mt-3 tw-text-center tw-text-sm">
						<pre className="tw-inline-block tw-whitespace-pre-line tw-break-all tw-border tw-p-2 dfr-border-color-secondary-inv">
							<Button
