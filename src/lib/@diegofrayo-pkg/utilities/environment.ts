...
export function isDevelopmentEnvironment() {
	return (
		WEBSITE_DOMAIN.includes(".dev") === false &&
		WEBSITE_DOMAIN.includes(".app") === false &&
		WEBSITE_DOMAIN.includes(".com") === false
	);
}
...
export function isLocalhostEnvironment() {
	return WEBSITE_DOMAIN.includes("//localhost") || WEBSITE_DOMAIN.includes("//127.0.0.1");
}
