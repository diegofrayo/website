...
1. Create the `package.json` file. Example:
   ...
   > **Important:**
   >
   > - `"name": "@my-organization/my-pkg"` | The name of the package must have this structure: **@organization/package-name**
   > - `"repository": "git://github.com/my-organization/my-pkg.git"` | Here, you have to set the URL of your repository
   > - `"publishConfig": {"registry": "https://npm.pkg.github.com"}` | This attribute serves to tell GitHub that you will publish this package to its registry
   > - `"private": false` | Even if the package will be private, the value of this attribute must be **false**
...
Sometimes, these kind of tasks are hard, specially for no expert people in deployments, servers and infrastructure like me. I hope that this tutorial has been useful for you, bye bye.
