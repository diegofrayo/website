...
import { getErrorMessage, throwError } from "@diegofrayo-pkg/utilities/errors";
import { readFile, writeFile } from "@diegofrayo-pkg/utilities/server/files";
import { parse, stringify } from "envfile";

async function main() {
	const localIP = getIP();
	const envVars = parse(readFile("./.env")) as EnvVars;
