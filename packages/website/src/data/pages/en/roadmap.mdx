...
<Collapsible title="English">
  <ToDoList>
    <li data-completed>
      Disable all uncompleted pages and blog posts
    </li>
    <li>
      Translate all content from Spanish to English (Leave blog posts to the end)
    </li>
    <li>
...
- [ ] Improve MDX styles (custom classes)

- [ ] Refactor Link component

- [ ] Error boundaries

- [ ] Components primitives (Button, collapsible, inputs)
...
- [ ] Improve useAssets arch

- [ ] Improve useInternationalization arch
