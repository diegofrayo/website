...
> **IMPORTANTE:** <br/> Para crear un **Registro TXT**, es necesario ingresar un _Host_. **Firebase** propone usar como _Host_ el nombre de nuestro dominio, por ejemplo `diegofrayo.com`. Yo **NO** usé el nombre de mi dominio como _Host_ para crear el **Registro TXT**, en vez de esto, usé el simbolo `@`.
...
3. Después de iniciar el proyecto, deberíamos tener la siguiente estructura de archivos.
  ...
  <Image src={DATA.blog_post.assets.image_3} alt="Estructura de nuestro proyecto" />
