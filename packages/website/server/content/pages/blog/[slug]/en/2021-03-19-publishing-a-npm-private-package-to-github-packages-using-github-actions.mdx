...
1. Create the `package.json` file. Example:
   ...
   > - `"publishConfig": {"registry": "https://npm.pkg.github.com"}` | This attribute serves to tell GitHub you will publish this package to its package registry
   > - `"private": false` | Even if the package will be private, the value of this attribute must be **false**

1. Create the `.yml` file of the workflow in `.github/workflows` folder.
