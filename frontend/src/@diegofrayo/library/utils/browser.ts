import type { T_SetTimeout } from "~/@diegofrayo/library/types/utils";
import type { T_ReactOnClickEventObject } from "~/@diegofrayo/library/types/react";
...
export function handleCopyToClipboardClick(
	...
	copyToClipboard(event.currentTarget.getAttribute("data-clipboard") || "");
}
...
export async function copyToClipboard(parameter: string): Promise<void> {
