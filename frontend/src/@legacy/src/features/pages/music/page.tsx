...
import { Link, Space, Input, Text, InlineText, Block } from "~/@legacy/src/components/primitive";
import { Render, Emoji } from "~/@legacy/src/components/shared";
import { I18nService, useTranslation } from "~/@legacy/src/features/i18n";
import { ROUTES } from "~/@legacy/src/features/routing";
import { useDidMount, useQuery } from "~/@legacy/src/hooks";
import v from "~/@legacy/src/lib/v";
import { focusElement } from "~/@legacy/src/utils/browser";
import { removeAccents } from "~/@legacy/src/utils/strings";
import type { T_ReactElement, T_ReactOnChangeEventHandler, T_ReactRef } from "~/@legacy/src/types";
