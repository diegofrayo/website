...
import { Icon, Input, Link, Block, Button, InlineText } from "~/@legacy/src/components/primitive";
import { useDidMount } from "~/@legacy/src/hooks";
import v from "~/@legacy/src/lib/v";
import { focusElement, handleCopyToClipboardClick } from "~/@legacy/src/utils/browser";
import { generateSlug, replaceAll } from "~/@legacy/src/utils/strings";
import type {
	T_ReactElement,
