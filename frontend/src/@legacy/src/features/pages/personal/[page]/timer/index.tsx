...
import { GoBack, Render } from "~/@legacy/src/components/shared";
...
import { setScrollPosition, isConfirmAlertAccepted } from "~/@legacy/src/utils/browser";
import { addLeftPadding } from "~/@legacy/src/utils/formatting";
