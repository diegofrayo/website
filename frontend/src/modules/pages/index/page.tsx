...
function HomePage({ data }: T_HomePageProps): T_ReactElement {
	return (
		<Page>
			<MainLayout>
...
type T_RoomProps = {
	...
	framePhoto: T_HomePageProps["data"]["photo"];
};

function Room({ tvSong, framePhoto }: T_RoomProps): T_ReactElement {
	return (
		<Block
